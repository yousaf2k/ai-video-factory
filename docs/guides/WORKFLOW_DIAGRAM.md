...
```
output/generated_images/project_20250207_143000/
└── shot_001.png
...
```json
{
  "10": {
    ...
    "inputs": {
      "image": "output/generated_images/project_20250207_143000/shot_001.png"
    }
  },
  "7": {
...
│                                                               │
│  LoadImage Node                                              │
│    └─ Reads: output/generated_images/project_XXX/shot_001   │
│         │                                                     │
│         ▼                                                     │
