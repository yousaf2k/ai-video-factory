...
### 1. Group by Scene Toggle
A new **Group by Scene** button has been added to the header of the shots grid. Toggling this will instantly reorganize all shots into groups based on the scene they belong to.

### 2. Scene Logic Headers
When grouping is enabled, each scene now has a dedicated header showing:
- **Scene Number**: Quick identification (e.g., "Scene 1").
- **Location**: The setting of the scene (e.g., "INT. CABIN").
- **Action Summary**: A brief italicized description of the scene's primary action.
...
## Benefits
- **Better Organization**: Clearly see which shots belong to which part of your story.
- **Focused Editing**: Filter down to a single scene to make batch adjustments or review flow without distractions.
