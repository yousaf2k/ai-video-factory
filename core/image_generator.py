...
def generate_image(prompt: str, output_path: str, aspect_ratio: str = None, resolution: str = None, mode: str = None, seed: int = None, workflow_name: str = None, step_progress_callback=None, project_title: str = None, reference_image_path: str = None) -> str:
    ...
    if mode == "comfyui":
        ...
        return generate_image_comfyui(prompt, output_path, seed=seed, workflow_name=workflow_name, aspect_ratio=aspect_ratio, progress_callback=step_progress_callback, reference_image_path=reference_image_path)
    elif mode == "geminiweb":
